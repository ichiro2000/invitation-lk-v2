...
async function migrate() {
  ...
  const tables = [
    ...
    \"ALTER TABLE \\\"Invitation\\\" ADD COLUMN IF NOT EXISTS \\\"userId\\\" TEXT UNIQUE REFERENCES \\\"User\\\"(id) ON DELETE CASCADE\",
    \"ALTER TABLE \\\"Invitation\\\" ADD COLUMN IF NOT EXISTS \\\"templateSlug\\\" TEXT\",
    \"ALTER TABLE \\\"Invitation\\\" ADD COLUMN IF NOT EXISTS slug TEXT UNIQUE\",
    \"ALTER TABLE \\\"Invitation\\\" ADD COLUMN IF NOT EXISTS \\\"groomName\\\" TEXT\",
    \"ALTER TABLE \\\"Invitation\\\" ADD COLUMN IF NOT EXISTS \\\"brideName\\\" TEXT\",
    \"ALTER TABLE \\\"Invitation\\\" ADD COLUMN IF NOT EXISTS \\\"weddingDate\\\" TIMESTAMP\",
    \"ALTER TABLE \\\"Invitation\\\" ADD COLUMN IF NOT EXISTS venue TEXT\",
    \"ALTER TABLE \\\"Invitation\\\" ADD COLUMN IF NOT EXISTS \\\"venueAddress\\\" TEXT\",
    \"ALTER TABLE \\\"Invitation\\\" ADD COLUMN IF NOT EXISTS \\\"isPublished\\\" BOOLEAN DEFAULT false\",
    \"ALTER TABLE \\\"Invitation\\\" ADD COLUMN IF NOT EXISTS \\\"isPaid\\\" BOOLEAN DEFAULT false\",
    \"ALTER TABLE \\\"Invitation\\\" ADD COLUMN IF NOT EXISTS \\\"updatedAt\\\" TIMESTAMP DEFAULT NOW()\",
