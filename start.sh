...
CREATE TABLE IF NOT EXISTS \"User\" (id TEXT PRIMARY KEY DEFAULT gen_random_uuid()::text, email TEXT NOT NULL UNIQUE, \"passwordHash\" TEXT, \"yourName\" TEXT NOT NULL, \"partnerName\" TEXT NOT NULL, \"weddingDate\" TIMESTAMP, venue TEXT, phone TEXT, role \"Role\" DEFAULT 'CUSTOMER', plan \"Plan\" DEFAULT 'FREE', image TEXT, \"emailVerified\" TIMESTAMP, \"createdAt\" TIMESTAMP DEFAULT NOW(), \"updatedAt\" TIMESTAMP DEFAULT NOW());
