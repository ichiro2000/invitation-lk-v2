...
const templates = [
  ...
  { slug: "blossom-waltz", name: "Blossom Waltz", category: "Modern", plan: "PREMIUM", couple: "Amaya & Nirash", date: "June 20, 2026", venue: "St. Andrew's Church + Cinnamon Grand", desc: "Modern pink floral wedding with signature rose bloom, cursor-follow petals, liquid blob animations, and two ceremonies — Church and Kandyan Poruwa.", bg: "from-pink-200 via-rose-100 to-pink-50", text: "text-pink-900", accent: "text-pink-500", icon: <Sparkles className="w-8 h-8 text-pink-500" /> },
];
